...
byte mac[] = { 0x40, 0x6c, 0x8f, 0x45, 0x84, 0x8b }; // Ethernet adapter shield S. Oosterhaven
int ethPort = 3301;                                  // Take a free port (check your router)
...
int pos = 180;                           // voor de servo
int eccoPin = 2;                        // voor de servo
int trigPin = 1;                        // voor de servo
int maximumRange = 15;                   // voor de servo
int minimumRange = 0;                    // voor de servo
long duration, distance;                 // voor de servo
...
void setup()
{
  ...
  pinMode(trigPin, OUTPUT);            // servo code
  pinMode(eccoPin, INPUT);
